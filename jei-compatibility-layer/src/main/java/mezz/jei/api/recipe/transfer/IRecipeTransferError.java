 ...
 * These errors are returned from {@link IRecipeTransferHandler#transferRecipe(AbstractContainerMenu, IRecipeLayout, Player, boolean, boolean)}.
 */
public interface IRecipeTransferError {
     ...
     */
    void showError(PoseStack matrixStack, int mouseX, int mouseY, IRecipeLayout recipeLayout, int recipeX, int recipeY);
}
