...
public interface DisplayHelper {
    ...
    public static interface DisplayBoundsHandler<T> {
         ...
         */
        default EnumActionResult canItemSlotWidgetFit(boolean isOnRightSide, int left, int top, T screen, Rectangle fullBounds) {
            return PASS;
        }
         ...
         */
        default EnumActionResult isInZone(boolean isOnRightSide, double mouseX, double mouseY) {
            return PASS;
        }
        ...
        default Rectangle getItemListArea(Rectangle rectangle) {
            return new Rectangle(rectangle.x + 2, rectangle.y + 24, rectangle.width - 4, rectangle.height - (RoughlyEnoughItemsClient.getConfigManager().getConfig().sideSearchField ? 27 + 22 : 27));
        }
