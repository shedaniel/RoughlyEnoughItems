...
public class DetailedButtonWidget extends ButtonWidget {
    ...
    public DetailedButtonWidget(Rectangle rectangle, ITextComponent text, PressAction pressAction) {
    ...
    public DetailedButtonWidget(int x, int y, int width, int height, ITextComponent text, PressAction pressAction) {
        super(x, y, width, height, text);
        this.pressAction = pressAction;
    }
