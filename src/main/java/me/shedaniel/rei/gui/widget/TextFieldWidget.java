...
public class TextFieldWidget extends Gui implements HighlightableWidget {
    ...
    public void draw(int int_1, int int_2, float float_1) {
        if (this.isVisible()) {
            ...
            int int_3 = this.editable ? this.editableColor : this.notEditableColor;
            ...
            if (!string_1.isEmpty()) {
                ...
                int_8 = this.fontRenderer.drawStringWithShadow((String) this.renderTextProvider.apply(string_2, this.field_2103), (float) int_6, (float) int_7, int_3);
            }
            ...
            if (!string_1.isEmpty() && boolean_1 && int_4 < string_1.length()) {
                this.fontRenderer.drawStringWithShadow((String) this.renderTextProvider.apply(string_1.substring(int_4), this.cursorMax), (float) int_8, (float) int_7, int_3);
            }
