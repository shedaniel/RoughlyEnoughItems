...
public class ConfigManager implements me.shedaniel.rei.api.ConfigManager {
    ...
    public ConfigManager() {
        this.oldConfigFile = new File(FMLPaths.CONFIGDIR.get().toFile(), "rei.json");
        this.configFile = new File(FMLPaths.CONFIGDIR.get().toFile(), "roughlyenoughitems/config.json");
